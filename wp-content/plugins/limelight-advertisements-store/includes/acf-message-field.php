...
*
*  @class 		acf_field_php_message
*  @extends		acf_field
*  @package		ACF
*  @subpackage	Fields
*/

if( ! class_exists('acf_field_php_message') ) :

	class acf_field_php_message extends acf_field {
		...
		*/
		...
		function __construct() {
			...
			// vars
			$this->name = 'php_message';
			$this->label = __("PHP Message",'acf');
		...
		*/
		...
		function render_field( $field ) {
			...
			// vars
			$m = apply_filters( 'acf_php_message_content', $field['message'], $field );
